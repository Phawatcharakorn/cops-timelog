        ...
        <section className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-4">
          ...
          <div className="space-y-2 pt-1">
            ...
            <div className="bg-gray-900 rounded-xl p-4 text-xs font-mono text-gray-300 space-y-1 leading-relaxed">
              ...
              <p className="pl-4 text-gray-400">id, student_id, check_in, check_out, work_summary, project_name, status (pending/approved), approved_by, approved_at, is_self_reported, is_student_edited, is_git_derived, is_rejected, rejected_reason, rejected_at, paid, paid_at</p>
