                              ...
                              {log.status === 'approved' ? (
                                <div className="space-y-2">
                                  ...
                                  <div className="flex flex-wrap gap-2 items-center">
                                    ...
                                    {log.paid ? (
                                      <button onClick={() => handleUnpay(log.id)} disabled={busyLogId === log.id}
                                        className="text-xs text-gray-400 hover:text-red-500 disabled:opacity-40 transition-colors whitespace-nowrap">
                                        ยกเลิกการจ่าย
                                      </button>
                                    ) : (
                                      <button onClick={() => handleUnapprove(log.id)} disabled={busyLogId === log.id}
                                        className="text-xs text-gray-400 hover:text-red-500 disabled:opacity-40 transition-colors whitespace-nowrap">
                                        ยกเลิกอนุมัติ
                                      </button>
                                    )}
                                ...
                                <div className="space-y-1.5">
                                  <div className="flex flex-wrap items-center gap-2">
                                    ...
                                    <button onClick={() => handleUndoReject(log.id)} disabled={busyLogId === log.id}
                                ...
                                <div className="flex flex-wrap items-center gap-2">
                                  ...
                                  <button onClick={() => handleApprove(log.id)} disabled={busyLogId === log.id}
                                  ...
                                  <button onClick={() => { setRejectModal({ id: log.id }); setRejectReason('') }} disabled={busyLogId === log.id}
