...
const s = StyleSheet.create({
  ...
  headerTitle:{ color: '#fff', fontSize: 9, fontWeight: 700, lineHeight: 1.8 },
  headerSub:  { color: '#c7d2fe', fontSize: 9, marginTop: 2, lineHeight: 1.8 },
  infoRow:    { flexDirection: 'row', gap: 8, marginBottom: 14 },
  infoCard:   { flex: 1, borderRadius: 6, border: '1 solid #e5e7eb', padding: '8 10' },
  infoLabel:  { color: '#6b7280', fontSize: 8, marginBottom: 3, lineHeight: 1.8 },
  infoValue:  { fontSize: 12, fontWeight: 700, color: '#1f2937', lineHeight: 1.8 },
  ...
  sectionTitle:{ fontSize: 10, fontWeight: 700, marginBottom: 6, color: '#374151', lineHeight: 1.8 },
  table:      { border: '1 solid #e5e7eb', borderRadius: 4 },
  thead:      { flexDirection: 'row', backgroundColor: '#f9fafb', borderBottom: '1 solid #e5e7eb' },
  theadCell:  { padding: '5 6', fontSize: 8, fontWeight: 700, color: '#6b7280', lineHeight: 1.8 },
  ...
  signLabel:  { fontSize: 8, color: '#6b7280', lineHeight: 1.8 },
  footer:     { position: 'absolute', bottom: 24, left: 40, right: 40, textAlign: 'center', fontSize: 8, color: '#9ca3af', lineHeight: 1.8 },
})
